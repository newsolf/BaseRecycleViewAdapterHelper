package com.newolf.library.adapt.base
...
import com.newolf.library.adapt.base.listener.*
import com.newolf.library.adapt.base.module.BaseLoadMoreModule
import com.newolf.library.adapt.base.module.LoadMoreModule
...
@JvmOverloads constructor(@LayoutRes private val layoutResId: Int,
    ...
    companion object {
        const val HEADER_VIEW = 0xA001
        const val LOAD_MORE_VIEW = 0xA002
        const val FOOTER_VIEW = 0xA003
        const val EMPTY_VIEW = 0xA004
    }
